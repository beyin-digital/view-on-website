...
import { Box, Button, Typography, Fade, Modal as MUIModal } from '@mui/material'
import { AiFillCloseCircle } from 'react-icons/ai'
import { FiArrowUpLeft, FiArrowUpRight } from 'react-icons/fi'

const ModalFooter = ({ open, close, onClick }: any) => {
  // translate hook
